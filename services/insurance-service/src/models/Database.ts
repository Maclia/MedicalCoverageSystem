...
/**
 * Database connection and configuration management for Insurance Service
 * Handles PostgreSQL connection with Drizzle ORM
 * Standard Singleton pattern used across all modern services
 */
export class Database {
  ...
  public async executeQuery(query: string, params?: any[]): Promise<any[]> {
    try {
      ...
      if (!hasAllowedPrefix) {
        throw new Error('Only SELECT, INSERT, UPDATE, DELETE queries are allowed for security reasons');
      }
